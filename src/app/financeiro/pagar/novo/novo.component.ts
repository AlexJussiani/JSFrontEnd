...
import { Cliente, Conta, ItemConta } from '../../models/contas';
...
export class PagarNovoComponent implements OnInit  {

  @ViewChildren(FormControlName, {read: ElementRef}) formInputElements: ElementRef[];

  TIPO_CONTA: string = "1" // A PAGAR
  ...
  constructor(
   ...
   ngOnInit(): void {
    ...
    this.contaService.obterFornecedores()
      .subscribe(
  ...
  processarSucesso(response: any) {
    ...
    if (toast) {
      toast.onHidden.subscribe(() => {
        this.router.navigate(['/financeiro/pagar/listar-todos']);
      });
    }
  }
  ...
  obterProdutos(){
    this.contaService.obterProdutosEntrada()
    .subscribe({
